...
public class FailTransaction extends JFrame{
	public FailTransaction(String title, String messageError) {
        setTitle("VietinBank");
        setSize(600, 500);
...
//        labelImg.setIcon(icon);
        ...
        JPanel circlePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.setColor(Color.RED); // Màu xanh lá cây
                ...
                g.drawString("x", 14, 28); // Vẽ dấu tích thành công
            }
        };
